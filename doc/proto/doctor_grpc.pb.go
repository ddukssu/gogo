...
func (c *doctorServiceClient) ListDoctors(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListDoctorsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedDoctorServiceServer) ListDoctors(context.Context, *Empty) (*ListDoctorsResponse, error) {
...
func _DoctorService_ListDoctors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DoctorServiceServer).ListDoctors(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
