...
const file_proto_doctor_proto_rawDesc = "" +
	...
	"\tGetDoctor\x12\x18.doctor.GetDoctorRequest\x1a\x16.doctor.DoctorResponse\x129\n" +
	"\vListDoctors\x12\r.doctor.Empty\x1a\x1b.doctor.ListDoctorsResponseB#Z!github.com/ddukssu/gogo/doc/protob\x06proto3"
...
var file_proto_doctor_proto_goTypes = []any{
	...
	(*DoctorResponse)(nil),      // 2: doctor.DoctorResponse
	(*ListDoctorsResponse)(nil), // 3: doctor.ListDoctorsResponse
	(*Empty)(nil),               // 4: doctor.Empty
}
var file_proto_doctor_proto_depIdxs = []int32{
	2, // 0: doctor.ListDoctorsResponse.doctors:type_name -> doctor.DoctorResponse
	...
	4, // 3: doctor.DoctorService.ListDoctors:input_type -> doctor.Empty
	2, // 4: doctor.DoctorService.CreateDoctor:output_type -> doctor.DoctorResponse
	2, // 5: doctor.DoctorService.GetDoctor:output_type -> doctor.DoctorResponse
	3, // 6: doctor.DoctorService.ListDoctors:output_type -> doctor.ListDoctorsResponse
